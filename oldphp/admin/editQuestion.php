...
<li>
	...
	<input type="text" name="questionImage" id="questionImage" value="<?=$question['questionImage']?>">
		<? if ($question['questionImage'] != '') { ?>
			<img src="http://qizpop.com/uplImages/<?=$question['questionImage']?>" width=80>
		<?}?>
...
<button class="submit" type="submit" class="btn btn-primary">Save</button>
</form>
<p>
	Created Date: <? if ($quizquestionid > 0) { echo date("m/d/Y H:i", strtotime($question["createdDate"])); }?>
</p>
